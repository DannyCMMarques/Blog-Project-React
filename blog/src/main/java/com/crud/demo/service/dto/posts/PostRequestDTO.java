...
public class PostRequestDTO {
    ...
    @Schema(description = "Conteúdo", example = "Nos últimos anos, a tecnologia tem avançado em um ritmo acelerado, trazendo inovações que impactam desde a forma como nos comunicamos até o modo como trabalhamos e aprendemos.\n"+
            ...
            "A sustentabilidade também ganhou destaque: cidades inteligentes estão adotando sistemas de energia renovável e redes de transporte mais eficientes para reduzir emissões de carbono.")    @NotBlank(message = "O conteúdo é obrigatório")
